...
export interface TileType {
  ...
  transition: (rotation?: number) => Tensor | Tensor[];
  generation?: (rotation: number) => PhotonGeneration[][];
  drawUnrotablePart?: (tile: Tile) => void;
  absorbSound?: () => void;
  absorbAnimation?: (tile: Tile) => void;
}

export const Vacuum: TileType = {
  svgName: 'vacuum',
  desc: {
...
export const CornerCube: TileType = {
  svgName: 'corner-cube',
  desc: {
    name: 'Corner Cube',
...
export const ThinMirror: TileType = {
  svgName: 'thin-mirror',
  desc: {
    name: 'Mirror',
  ...
  maxRotation: 4, // - / | \
  rotationAngle: 45,
  transition: (rotation?: number) => full.thinMirror[rotation ?? 0]!,
};

// most likely it will fo as "BeamSplitter"
export const ThinSplitter: TileType = {
  ...
  maxRotation: 4, // - / | \
  rotationAngle: 45,
  transition: (rotation?: number) => full.thinSplitter[rotation ?? 0]!,
};

export const ThinSplitterCoated: TileType = {
  ...
  maxRotation: 8, // - / | \ - / | \
  rotationAngle: 45,
  transition: (rotation?: number) => full.thinSplitterCoated[rotation ?? 0]!,
};

export const PolarizingSplitter: TileType = {
  ...
  maxRotation: 2, // / \
  rotationAngle: 90,
  transition: (rotation?: number) => full.polarizingSplitter[rotation ?? 0]!,
};

// deprecated
export const Polarizer: TileType = {
  svgName: 'polarizer',
  desc: {
  ...
  maxRotation: 4, // - / | \
  rotationAngle: 45,
  transition: (rotation?: number) => full.polarizer[rotation ?? 0]!,
  drawUnrotablePart: (that: Tile) => {
    that.g.append('line')
      .attr('class', 'wire')
...
export const PolarizerNS: TileType = {
  ...
  maxRotation: 4, // - / | \
  rotationAngle: 45,
  transition: (rotation?: number) => full.polarizerNS[rotation ?? 0]!,
  drawUnrotablePart: (that: Tile) => {
   that.g.append('path')
...
export const PolarizerWE: TileType = {
  ...
  maxRotation: 4, // - / | \
  rotationAngle: 45,
  transition: (rotation?: number) => full.polarizerWE[rotation ?? 0]!,
  drawUnrotablePart: (that: Tile) => {
    that.g.append('path')
      .attr('class', 'metal-edge polarizer-side')
...
// deprecated
export const QuarterWavePlate: TileType = {
  ...
  maxRotation: 4, // - / | \
  rotationAngle: 45,
  transition: (rotation?: number) => full.quarterWavePlate[rotation ?? 0]!,
};

export const QuarterWavePlateNS: TileType = {
  ...
  maxRotation: 4, // - / | \
  rotationAngle: 45,
  transition: (rotation?: number) => full.quarterWavePlateNS[rotation ?? 0]!,
  drawUnrotablePart: (that: Tile) => {
    that.g.append('path')
...
export const QuarterWavePlateWE: TileType = {
  ...
  maxRotation: 4, // - / | \
  rotationAngle: 45,
  transition: (rotation?: number) => full.quarterWavePlateWE[rotation ?? 0]!,
  drawUnrotablePart: (that: Tile) => {
    that.g.append('path')
      .attr('class', 'glass-edge glass')
...
export const SugarSolution: TileType = {
...
export const DoubleSugarSolution: TileType = {
...
export const VacuumJar: TileType = {
  svgName: 'vacuum-jar',
  desc: {
    name: 'Vacuum Jar',
...
export const Absorber: TileType = {
  svgName: 'absorber',
  desc: {
...
export const Detector: TileType = {
  svgName: 'detector',
  desc: {
  ...
  maxRotation: 4, // > ^ < v
  rotationAngle: 90,
  transition: (rotation?: number) => full.detector[rotation ?? 0]!,
  absorbSound: () => {
...
export const DetectorFour: TileType = {
...
export const FaradayRotator: TileType = {
  ...
  maxRotation: 4, // > ^ < v
  rotationAngle: 90,
  transition: (rotation?: number) => full.faradayRotator[rotation ?? 0]!,
};
...
export class Tile {
  ...
  get transitionAmplitudes(): Tensor | Tensor[] {
